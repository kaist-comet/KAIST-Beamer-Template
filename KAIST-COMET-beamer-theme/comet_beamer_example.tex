...
% Title Page Logo Setting (none or ISE or GSDS)
%\usetheme{Comet}
\usetheme[logo=ise]{Comet}
%\usetheme[logo=gsds]{Comet}
...
\setbeamerfont{title page title}{family=\fontspec{Montserrat}, series=\bfseries, size=\huge} 
\setbeamerfont{title page author}{family=\sffamily, series=\bfseries, size=\normalsize}   
\setbeamerfont{title page logo}{family=\fontspec{Montserrat}, size=\scriptsize}   
