...
\begin{center}
\includegraphics<1>[width=0.7\textwidth]{example-image-a}
\includegraphics<2>[width=0.7\textwidth]{example-image-b}
\includegraphics<3>[width=0.7\textwidth]{example-image-c}
\end{center}
\end{frame}
...
Good bye world. \email{chkwon@kaist.ac.kr}
